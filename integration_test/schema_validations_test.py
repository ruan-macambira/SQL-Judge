...
def test_extract_validations(extracted_validations, validations_module):
...
def test_inspect_validations(extracted_validations):
    assert inspect_validations(extracted_validations) == ["'invalid_entity' is not a valid entity"]

def test_to_configuration(extracted_validations, validations_module):
